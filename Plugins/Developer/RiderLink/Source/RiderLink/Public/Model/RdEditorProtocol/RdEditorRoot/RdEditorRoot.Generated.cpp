...
namespace JetBrains::EditorPlugin
{
	...
	const RdEditorRoot::RdEditorRootSerializersOwner RdEditorRoot::serializersOwner;
	...
	void RdEditorRoot::connect(rd::Lifetime lifetime, const rd::IProtocol* protocol)
	{
		serializersOwner.registry(protocol->get_serializers());
