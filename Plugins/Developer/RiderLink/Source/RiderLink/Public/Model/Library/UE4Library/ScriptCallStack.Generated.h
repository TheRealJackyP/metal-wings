...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		ScriptCallStack(const ScriptCallStack&) = default;

		ScriptCallStack& operator=(const ScriptCallStack&) = default;

		ScriptCallStack(ScriptCallStack&&) = default;

		ScriptCallStack& operator=(ScriptCallStack&&) = default;

		virtual ~ScriptCallStack() override = default;
		...
		// getters
		const TArray<rd::Wrapper<ScriptCallStackFrame>>& get_frames() const;
