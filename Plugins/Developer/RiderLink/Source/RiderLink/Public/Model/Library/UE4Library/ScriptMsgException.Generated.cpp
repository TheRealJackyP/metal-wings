...
namespace JetBrains::EditorPlugin
{
	...
	// identify
	// getters
	const FString& ScriptMsgException::get_message() const
	{
		return message_;
	}
	...
	// intern
	// equals trait
	bool ScriptMsgException::equals(const ISerializable& object) const
	{
		const auto& other = dynamic_cast<const ScriptMsgException&>(object);
		if (this == &other)
		{
			return true;
		}
