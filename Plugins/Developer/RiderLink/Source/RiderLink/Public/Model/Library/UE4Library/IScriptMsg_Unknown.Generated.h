...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		IScriptMsg_Unknown(const IScriptMsg_Unknown&) = default;

		IScriptMsg_Unknown& operator=(const IScriptMsg_Unknown&) = default;

		IScriptMsg_Unknown(IScriptMsg_Unknown&&) = default;

		IScriptMsg_Unknown& operator=(IScriptMsg_Unknown&&) = default;

		virtual ~IScriptMsg_Unknown() override = default;
