...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		IScriptCallStack(const IScriptCallStack&) = default;

		IScriptCallStack& operator=(const IScriptCallStack&) = default;

		IScriptCallStack(IScriptCallStack&&) = default;

		IScriptCallStack& operator=(IScriptCallStack&&) = default;

		virtual ~IScriptCallStack() override = default;

		// reader
		static rd::Wrapper<IScriptCallStack> readUnknownInstance(
