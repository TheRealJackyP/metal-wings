...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		BlueprintFunction(const BlueprintFunction&) = default;

		BlueprintFunction& operator=(const BlueprintFunction&) = default;

		BlueprintFunction(BlueprintFunction&&) = default;

		BlueprintFunction& operator=(BlueprintFunction&&) = default;

		virtual ~BlueprintFunction() override = default;
...
namespace std
{
	template <>
	class tuple_size<
			JetBrains::EditorPlugin::BlueprintFunction> : public integral_constant<
			size_t, 2>
	{
	};
	...
	{
	public:
		using type = decltype (declval<JetBrains::EditorPlugin::BlueprintFunction>().get
			<I>());
	};
}
#endif
