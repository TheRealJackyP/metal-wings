...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		static constexpr rd::wstring_view message{
			L"Script call stack: [Empty] (FFrame::GetStackTrace() called from native code)",
			76
		};
	...
	public:
		...
		EmptyScriptCallStack(const EmptyScriptCallStack&) = default;

		EmptyScriptCallStack& operator=(const EmptyScriptCallStack&) = default;

		EmptyScriptCallStack(EmptyScriptCallStack&&) = default;

		EmptyScriptCallStack& operator=(EmptyScriptCallStack&&) = default;

		virtual ~EmptyScriptCallStack() override = default;
...
namespace rd
{
	...
	{
		size_t operator()(
			const JetBrains::EditorPlugin::EmptyScriptCallStack& value) const noexcept
		{
