...
namespace JetBrains::EditorPlugin
{
	...
	IScriptMsg_Unknown::IScriptMsg_Unknown(rd::RdId unknownId_,
		...
		IScriptMsg(), IUnknownInstance(std::move(unknownId_))
	...
	// intern
	// equals trait
	bool IScriptMsg_Unknown::equals(const ISerializable& object) const
	{
		const auto& other = dynamic_cast<const IScriptMsg_Unknown&>(object);
		if (this == &other)
		{
			return true;
		}
