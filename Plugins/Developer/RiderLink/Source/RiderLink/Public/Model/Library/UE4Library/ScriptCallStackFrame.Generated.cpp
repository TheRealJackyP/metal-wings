...
namespace JetBrains::EditorPlugin
{
	...
	// identify
	// getters
	const FString& ScriptCallStackFrame::get_entry() const
	{
		return entry_;
	}
	...
	// intern
	// equals trait
	bool ScriptCallStackFrame::equals(const ISerializable& object) const
	{
		const auto& other = dynamic_cast<const ScriptCallStackFrame&>(object);
		if (this == &other)
		{
			return true;
		}
