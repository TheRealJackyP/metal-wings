...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		RequestFailed(const RequestFailed&) = default;

		RequestFailed& operator=(const RequestFailed&) = default;

		RequestFailed(RequestFailed&&) = default;

		RequestFailed& operator=(RequestFailed&&) = default;

		virtual ~RequestFailed() override = default;
		...
		// getters
		const NotificationType& get_type() const;
