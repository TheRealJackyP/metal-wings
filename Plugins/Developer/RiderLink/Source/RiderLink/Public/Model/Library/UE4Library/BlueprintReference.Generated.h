...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		BlueprintReference(const BlueprintReference&) = default;

		BlueprintReference& operator=(const BlueprintReference&) = default;

		BlueprintReference(BlueprintReference&&) = default;

		BlueprintReference& operator=(BlueprintReference&&) = default;

		virtual ~BlueprintReference() override = default;
		...
		// getters
		const FString& get_pathName() const;
...
namespace std
{
	template <>
	class tuple_size<
			JetBrains::EditorPlugin::BlueprintReference> : public integral_constant<
			size_t, 1>
	{
	};
	...
	{
	public:
		using type = decltype (declval<JetBrains::EditorPlugin::BlueprintReference>().
			get<I>());
	};
}
#endif
