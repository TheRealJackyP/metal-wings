...
namespace JetBrains::EditorPlugin
{
	...
	// identify
	// getters
	const int32_t& StringRange::get_first() const
	{
		return first_;
	}

	const int32_t& StringRange::get_last() const
	{
		return last_;
	}
	...
	// intern
	// equals trait
	bool StringRange::equals(const ISerializable& object) const
	{
		const auto& other = dynamic_cast<const StringRange&>(object);
		if (this == &other)
		{
			return true;
		}
