...
namespace JetBrains::EditorPlugin
{
	...
	// identify
	// getters
	const int32_t& BlueprintHighlighter::get_begin() const
	{
		return begin_;
	}

	const int32_t& BlueprintHighlighter::get_end() const
	{
		return end_;
	}
	...
	// intern
	// equals trait
	bool BlueprintHighlighter::equals(const ISerializable& object) const
	{
		const auto& other = dynamic_cast<const BlueprintHighlighter&>(object);
		if (this == &other)
		{
			return true;
		}
