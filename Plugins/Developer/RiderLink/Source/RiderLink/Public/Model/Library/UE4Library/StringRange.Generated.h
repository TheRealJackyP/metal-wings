...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		StringRange(const StringRange&) = default;

		StringRange& operator=(const StringRange&) = default;

		StringRange(StringRange&&) = default;

		StringRange& operator=(StringRange&&) = default;

		virtual ~StringRange() override = default;
		...
		// getters
		const int32_t& get_first() const;
		const int32_t& get_last() const;
...
namespace rd
{
	...
	{
		size_t operator()(
			const JetBrains::EditorPlugin::StringRange& value) const noexcept
		{
...
namespace std
{
	template <>
	class tuple_size<
			JetBrains::EditorPlugin::StringRange> : public integral_constant<size_t, 2>
	{
	};
