...
namespace JetBrains::EditorPlugin
{
	...
	// reader
	UnableToDisplayScriptCallStack UnableToDisplayScriptCallStack::read(
	...
	// intern
	// equals trait
	bool UnableToDisplayScriptCallStack::equals(const ISerializable& object) const
	{
		const auto& other = dynamic_cast<const UnableToDisplayScriptCallStack&>(object);
		if (this == &other)
		{
			return true;
		}
