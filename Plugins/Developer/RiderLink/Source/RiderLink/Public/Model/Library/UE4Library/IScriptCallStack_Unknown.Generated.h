...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		IScriptCallStack_Unknown(const IScriptCallStack_Unknown&) = default;

		IScriptCallStack_Unknown& operator=(const IScriptCallStack_Unknown&) = default;
		...
		virtual ~IScriptCallStack_Unknown() override = default;
...
namespace rd
{
	...
	{
		size_t operator()(
			const JetBrains::EditorPlugin::IScriptCallStack_Unknown& value) const
		noexcept
		{
