...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		IScriptMsg(const IScriptMsg&) = default;

		IScriptMsg& operator=(const IScriptMsg&) = default;

		IScriptMsg(IScriptMsg&&) = default;

		IScriptMsg& operator=(IScriptMsg&&) = default;

		virtual ~IScriptMsg() override = default;

		// reader
		static rd::Wrapper<IScriptMsg> readUnknownInstance(
...
namespace rd
{
	...
	{
		size_t operator()(
			const JetBrains::EditorPlugin::IScriptMsg& value) const noexcept
		{
