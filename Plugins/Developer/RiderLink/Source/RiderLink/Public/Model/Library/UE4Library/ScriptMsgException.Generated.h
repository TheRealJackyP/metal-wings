...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		ScriptMsgException(const ScriptMsgException&) = default;

		ScriptMsgException& operator=(const ScriptMsgException&) = default;

		ScriptMsgException(ScriptMsgException&&) = default;

		ScriptMsgException& operator=(ScriptMsgException&&) = default;

		virtual ~ScriptMsgException() override = default;
