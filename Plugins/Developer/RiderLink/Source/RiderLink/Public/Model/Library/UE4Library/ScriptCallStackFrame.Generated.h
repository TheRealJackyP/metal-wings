...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		ScriptCallStackFrame(const ScriptCallStackFrame&) = default;

		ScriptCallStackFrame& operator=(const ScriptCallStackFrame&) = default;

		ScriptCallStackFrame(ScriptCallStackFrame&&) = default;

		ScriptCallStackFrame& operator=(ScriptCallStackFrame&&) = default;

		virtual ~ScriptCallStackFrame() override = default;
...
namespace rd
{
	...
	{
		size_t operator()(
			const JetBrains::EditorPlugin::ScriptCallStackFrame& value) const noexcept
		{
...
namespace std
{
	template <>
	class tuple_size<
			JetBrains::EditorPlugin::ScriptCallStackFrame> : public integral_constant<
			size_t, 1>
	{
	};
