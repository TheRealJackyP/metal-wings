...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		BlueprintHighlighter(const BlueprintHighlighter&) = default;

		BlueprintHighlighter& operator=(const BlueprintHighlighter&) = default;

		BlueprintHighlighter(BlueprintHighlighter&&) = default;

		BlueprintHighlighter& operator=(BlueprintHighlighter&&) = default;

		virtual ~BlueprintHighlighter() override = default;
		...
		// getters
		const int32_t& get_begin() const;
		const int32_t& get_end() const;
...
namespace rd
{
	...
	{
		size_t operator()(
			const JetBrains::EditorPlugin::BlueprintHighlighter& value) const noexcept
		{
...
namespace std
{
	template <>
	class tuple_size<
			JetBrains::EditorPlugin::BlueprintHighlighter> : public integral_constant<
			size_t, 2>
	{
	};
