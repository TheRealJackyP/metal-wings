...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		RequestResultBase_Unknown(const RequestResultBase_Unknown&) = default;

		RequestResultBase_Unknown& operator=(const RequestResultBase_Unknown&) = default
		;
		...
		virtual ~RequestResultBase_Unknown() override = default;
...
namespace rd
{
	...
	{
		size_t operator()(
			const JetBrains::EditorPlugin::RequestResultBase_Unknown& value) const
		noexcept
		{
