...
namespace JetBrains::EditorPlugin
{
	...
	public:
		...
		ScriptMsgCallStack(const ScriptMsgCallStack&) = default;

		ScriptMsgCallStack& operator=(const ScriptMsgCallStack&) = default;

		ScriptMsgCallStack(ScriptMsgCallStack&&) = default;

		ScriptMsgCallStack& operator=(ScriptMsgCallStack&&) = default;

		virtual ~ScriptMsgCallStack() override = default;
		...
		// getters
		const FString& get_message() const;
		const IScriptCallStack& get_scriptCallStack() const;
