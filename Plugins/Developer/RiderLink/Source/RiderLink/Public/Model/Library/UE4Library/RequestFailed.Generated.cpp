...
namespace JetBrains::EditorPlugin
{
	...
	// identify
	// getters
	const NotificationType& RequestFailed::get_type() const
	{
		return type_;
	}

	const FString& RequestFailed::get_message() const
	{
		return message_;
	}
	...
	// intern
	// equals trait
	bool RequestFailed::equals(const ISerializable& object) const
	{
		const auto& other = dynamic_cast<const RequestFailed&>(object);
		if (this == &other)
		{
			return true;
		}
