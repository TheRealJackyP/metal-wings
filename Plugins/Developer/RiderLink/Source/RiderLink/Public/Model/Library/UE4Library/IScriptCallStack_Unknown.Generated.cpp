...
namespace JetBrains::EditorPlugin
{
	...
	IScriptCallStack_Unknown::IScriptCallStack_Unknown(
		...
		IScriptCallStack(), IUnknownInstance(std::move(unknownId_))
	...
	// reader
	IScriptCallStack_Unknown IScriptCallStack_Unknown::read(
	...
	// intern
	// equals trait
	bool IScriptCallStack_Unknown::equals(const ISerializable& object) const
	{
		const auto& other = dynamic_cast<const IScriptCallStack_Unknown&>(object);
		if (this == &other)
		{
			return true;
		}
