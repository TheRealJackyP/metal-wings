...
inline std::string to_string(const FString& val)
{
	return TCHAR_TO_UTF8(*val);
}

template <typename T, typename A>
int32_t size(const TArray<T, A>& value)
{
...
namespace rd
{
	...
	public:
		...
		static void write(SerializationCtx& ctx, Buffer& buffer, const FString& value);
	};
