...
namespace rd
{
	...
	{
		mutable std::unordered_set<const Serializers*> used;
	...
	public:
		...
		void registry(const Serializers& serializers) const;

		virtual void registerSerializersCore(const Serializers& serializers) const = 0;
	};
} // namespace rd
#if defined(_MSC_VER)
#pragma warning(pop)
