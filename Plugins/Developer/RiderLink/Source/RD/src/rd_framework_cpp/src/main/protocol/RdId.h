...
namespace rd
{
	...
	public:
		friend bool RD_FRAMEWORK_API operator==(const RdId& left, const RdId& right);
		...
		{
			return RdId(
				util::getPlatformIndependentHash(
		...
		*/
		...
		friend std::string RD_FRAMEWORK_API to_string(const RdId& id);
	};
