...
namespace rd
{
	...
	private:
		...
		mutable unordered_map<RdId, const IRdReactive*> subscriptions;
		mutable unordered_map<RdId, Mq> broker;
	...
	public:
		...
		void advise_on(Lifetime lifetime, const IRdReactive* entity) const;
	};
} // namespace rd
#if defined(_MSC_VER)
#pragma warning(pop)
