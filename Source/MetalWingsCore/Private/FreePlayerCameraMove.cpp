...
// Called every frame
void UFreePlayerCameraMove::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UFreePlayerCameraMove::MoveCamera_Implementation(FVector PlayerInputVector, float DeltaTime)
{
	FVector currentLocation = Owner->GetActorLocation();
	FVector targetDirection = PlayerInputVector.X * RightVector + PlayerInputVector.Y * ForwardVector;
